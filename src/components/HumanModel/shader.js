...
import frag_human from "./shader/frag_human.glsl";
import vert_human from "./shader/vert_human.glsl";

//export const shader_human = { vertex: vertex_human, fragment: fragment_human }
